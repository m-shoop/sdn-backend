...
<section class="panel pin-panel beige-bg sched-panel" style="flex-direction: column;">
    ...
    <div>
        ...
        <p class="text-box">
            Ready to book your next amazing set? Just click on the link that follows, wait for the scheduling widget to
            load, and choose the Lakwerk Den Bosch location.
            <br /><br />
            If you run into problems,
            feel free to connect with me on Instagram. I'll be happy to help! :)
        </p>
    </div>

    <div class="spacing"></div>

    <div class="sched-anim1">
        <h4>
            <a href="https://lakwerk.com/book-now/" class="link-light custom-button pink-bg schedule-button" rel="noopener noreferrer"
                target="_blank">
